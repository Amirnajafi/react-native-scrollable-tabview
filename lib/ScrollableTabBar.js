...
export default class ScrollableTabBar extends Component {
  ...
  renderTab(name, page, isTabActive, onPressHandler, onLayoutHandler , parent) {
    ...
    >
      <View style={[styles.tab, this.props.tabStyle]}>
       {parent &&
          <Text style={[{color: inactiveTextColor, fontWeight}, textStyle, {fontSize: 9}]}>
            {parent}
          </Text>
        }
      ...
      >
        ...
        >
          {this.props.tabs.map((name, page) => {
            ...
            return renderTab(name, page, isTabActive, this.props.goToPage, this.measureTab.bind(this, page) , this.props.parents[page])
          })}
